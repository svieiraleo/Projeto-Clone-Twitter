...
function criarTweet(tweetTexto){
  ...
  let data = new Date();
  let horaFormatada = data.getHours().toString().padStart(2, '0') + ':' + data.getMinutes().toString().padStart(2,'0');//Os parâmetros do método padStart são: o tamanho dastring final (no caso, 2), a string usada para preencher no início (no caso, '0').
